<div class="container">
	<div class="card">
		<div class="card-header text-center"><h4>Edit KK Lama</h4></div>
		<div class="card-body">
			<a href="<?php echo base_url().'petugas/kk_lama' ?>" class='btn btn-sm btn-light btn-outline-dark pull-right'>
				<i class="fa fa-arrow-left"></i> Kembali</a>
				<br/><br/>
				<?php foreach($kk_lama as $b)
				{	?>
						<form method="post" action="<?php echo base_url().'petugas/kl_update'; ?>">
						<div class="form-group">
								<label class="font-weight-bold" for="no_kk_lama">Nomor KK Lama</label>
								<input type="hidden" name="id" value="<?php echo $b->no_kk_lama; ?>">
								<input type="text" class="form-control" name="no_kk_lama" placeholder="Masukkan Nomor KK Lama" 
									required="required" value="<?php echo $b->no_kk_lama; ?>">
							</div><div class="form-group">
					<label class="font-weight-bold" for="nama_kep_kel">Nama Kepala Keluarga</label>
					<input type="text" class="form-control" name="nama_kep_kel" placeholder="Masukkan Nama Kepala Keluarga" 
					required="required" value="<?php echo $b->nama_kep_kel; ?>">
				</div>
				<div class="form-group">
