<div class="container">
	<div class="card">
		<div class="card-header text-center"> <h4>Tambah KK Lama</h4> </div>
		<div class="card-body">
			<a href="<?php echo base_url().'petugas/kk_lama' ?>" class='btn btn-sm btnlight btn-outline-dark pul-right'> 
				<i class="fa fa-arrow-left"> </i> Kembali</a>
			<br/>
			<br/>
			<form method="post" action="<?php echo base_url().'petugas/kl_tambah_aksi'; ?>">
				<div class="form-group">
					<label class="font-weight-bold" for="no_kk_lama">No KK Lama</label>
					<input type="text" class="form-control" name="no_kk_lama" placeholder="Masukkan No KK Lama" required="required">
				</div>
				<div class="form-group">
					<label class="font-weight-bold" for="nama_kep_kel">Nama Kepala Keluarga</label>
					<input type="text" class="form-control" name="nama_kep_kel" placeholder="Masukkan Nama Kepala Keluarga" required="required">
				</div>
				<div class="form-group">
